...
import makanan1 from "./gambar/makananPekanbaru1.png";
import makanan2 from "./gambar/makananPekanbaru2.png";
import makanan3 from "./gambar/makananPekanbaru3.png";
...
import museum1 from "../../../gambar/pekanbaru1.png";
import museum2 from "../../../gambar/pekanbaru2.png";
...
const Museum = () => {
  ...
  const handleMenang = () => {
    if (healthMusuh <= 10) {
      ...
      let count1 = makananPekanbaru1;
      let count2 = makananPekanbaru2;
      let count3 = makananPekanbaru3;

      if (makananPekanbaru1 > 0) {
        while (count1 > 0) {
          setMakanan1(makananPekanbaru1 - 1);
          count1 -= 1;
          totalMoney += 10;
  ...
  const handleAnimateDarahBuff = () => {
    ...
    setTimeout(() => {
      ...
      darah.style.width = `${(healthh * 3.15) / 2}px`;
    }, 1)
    setTimeout(() => {
  ...
  const handleAttackMusuh = () => {
    ...
    setTimeout(() => {
      ...
      darahmusuh.style.width = `${(healthMusuhh * 1.72421053) / 1.3}px`;
    }, 500)
          ...
          >
            <div className="relative">
              ...
              <div className="absolute grid grid-cols-3 text-center mx-96 place-items-center">
                ...
                <div className="w-5/12">
                  <h3>{makananPekanbaru2}/10</h3>
                  <img src={makanan2} alt="Makanan2" 
                  onClick={handleTambah2}
                  className="w-12/12 mx-auto cursor-pointer hover:drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]"/>
                </div>
                <div className="w-5/12">
                  <h3>{makananPekanbaru3}/10</h3>
