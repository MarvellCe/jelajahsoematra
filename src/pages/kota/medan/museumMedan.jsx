...
import makanan1 from "./gambar/makananMedan1.png";
import makanan2 from "./gambar/makananMedan2.png";
import makanan3 from "./gambar/makananMedan3.png";
...
import museum1 from "../../../gambar/medan1.png";
import museum2 from "../../../gambar/medan2.png";
import museum3 from "../../../gambar/medan3.png";
...
const Museum = () => {
  ...
  const [healthMusuh, setMusuh] = useState(130);
  ...
  const handleTambah1 = () => {
    if (makananMedan1 < 1) {
      ...
      handleBuff();
      if (sunny === true) {
        setMakanan1(makananMedan1 - 1);
        setDamage(buff + 10);
        if (health > 104 && health < 106){
          setHealth(health + buff + 5);
          handleAnimateDarah15();
        }else if (health > 109 && health < 111) {
          setHealth(health + buff);
          handleAnimateDarahNormal();      
        } else if (health > 114 && health < 116){
          setHealth(health + buff - 5);
  ...
  const handleMenang = () => {
    if (healthMusuh <= 10) {
      ...
      let count1 = makananMedan1;
      let count2 = makananMedan2;
      let count3 = makananMedan3;
  ...
  const handleAnimateDarahBuff = () => {
    ...
    setTimeout(() => {
      ...
      darah.style.width = `${(healthh * 4.20) / 2}px`;
    }, 1)
    setTimeout(() => {
  ...
  const handleAttackMusuh = () => {
    ...
    setTimeout(() => {
      ...
      darahmusuh.style.width = `${(healthMusuhh * 2.52) / 1.3}px`;
    }, 500)
