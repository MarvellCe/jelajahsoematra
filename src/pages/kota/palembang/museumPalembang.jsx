...
import makanan1 from "./gambar/makananPalembang1.png";
import makanan2 from "./gambar/makananPalembang2.png";
import makanan3 from "./gambar/makananPalembang3.png";
...
import museum1 from "../../../gambar/palembang1.png";
import museum2 from "../../../gambar/palembang1.png";
...
const Museum = () => {
  ...
  const [healthMusuh, setMusuh] = useState(220);
  ...
  const handleMenang = () => {
    if (healthMusuh <= 10) {
      ...
      let count1 = makananPalembang1;
      let count2 = makananPalembang2;
      let count3 = makananPalembang3;

      if (makananPalembang1 > 0) {
        while (count1 > 0) {
          setMakanan1(makananPalembang1 - 1);
          count1 -= 1;
          totalMoney += 10;
  ...
  const handleAnimateDarahBuff = () => {
    ...
    setTimeout(() => {
      ...
      darah.style.width = `${(healthh * 2.80) / 2}px`;
    }, 1)
    setTimeout(() => {
  ...
  const handleAttackMusuh = () => {
    ...
    setTimeout(() => {
      ...
      darahmusuh.style.width = `${(healthMusuhh * 1.48909091) / 1.3}px`;
    }, 500)
          ...
          >
            <div className="relative">
              ...
              <div className="absolute grid grid-cols-3 text-center mx-96 place-items-center">
                ...
                <div className="w-5/12">
                  <h3>{makananPalembang2}/10</h3>
                  <img src={makanan2} alt="Makanan2" 
                  onClick={handleTambah2}
                  className="w-12/12 mx-auto cursor-pointer hover:drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]"/>
                </div>
                <div className="w-5/12">
                  <h3>{makananPalembang3}/10</h3>
